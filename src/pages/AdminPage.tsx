                ...
                <>
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="pt-2 text-center">
                          ...
                          <p class="text-xs text-[#5a4510] mt-3 max-w-xs mx-auto">
                            Have potential customers scan this QR code. They'll
                            have to log in to their Google account to sign up.
                          </p>
                        </div>
                        {/* Book for a Client */}
                        ...
                        <div class="pt-2 border-t border-red-200">
                          <div class="text-center">
                            ...
                            <p class="text-xs text-[#5a4510] mt-2 max-w-xs mx-auto">
                              Permanently delete this provider's account,
                              calendar, and all data. This action cannot be
                              undone.
                            </p>
                          </div>
                        </div>
                    ...
                    <AdminCard title="Configuration">
                      <ConfigTable
                        rows={[
                          ...
                          {
                            name: "Minimum Appointment Delay",
                  ...
                  <AdminCard title="Privacy & Data Management">
                    <div class="space-y-6">
                      {/* Connected Account */}
                      <div>
                        <h3 class="text-sm font-semibold text-[#3d2e0a] mb-2">
                      ...
                      <div>
                        ...
                        <ul class="text-sm text-[#5a4510] space-y-1 list-disc list-inside">
                          <li>
                            <strong>calendar.app.created</strong>{" "}
                            - Access ONLY to calendars created by WellAppoint
                            (not your other calendars)
                          </li>
                          <li>
                      ...
                      <div>
                        <h3 class="text-sm font-semibold text-[#3d2e0a] mb-2">
                          Data Stored by WellAppoint
                        </h3>
                        <div class="text-sm text-[#5a4510] space-y-2">
                          <p>
                            <strong>WellAppoint Calendar ID:</strong>{" "}
                            <code class="text-xs bg-[#f5f0e8] px-1 py-0.5 rounded">
                              {data().config.availabilityCalendarId}
                            </code>
                          </p>
                          <p>
                            <strong>Admin Spreadsheet ID:</strong>{" "}
                            <code class="text-xs bg-[#f5f0e8] px-1 py-0.5 rounded">
                              {data().config.adminSheetId}
                            </code>
                          </p>
                          <p class="text-xs italic text-[#5a4510]">
                            Note: We also store an encrypted OAuth refresh token
                            to access your WellAppoint calendar. All data is
                      ...
                      <div>
                        ...
                        <div class="flex gap-4 text-sm">
                          <a
                            href="/privacy"
                            target="_blank"
                            class="text-[#8B6914] hover:underline inline-flex items-center gap-1"
                          >
                            Privacy Policy
                      ...
                      <div class="border-t border-[#8B6914]/10 pt-4">
                        <h3 class="text-sm font-semibold text-[#3d2e0a] mb-3">
                          Data Management
                        </h3>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                          ...
                          >
                            <Show
                              when={!isExportingData()}
                              fallback={<span>Exporting...</span>}
                            >
                              Export My Data
                            </Show>
                          </button>
                          ...
                          >
                            <Show
                              when={!isRevokingAccess()}
                              fallback={<span>Revoking...</span>}
                            >
                              Revoke Access
                            </Show>
                          </button>
                        ...
                        <p class="text-xs text-[#5a4510] mt-3">
                          ...
                          Download all your data (appointments, services,
                          settings) as JSON.
                          <br />
                          <strong>Revoke Access:</strong>{" "}
                          Disconnect WellAppoint from your Google account.
                          You'll need to re-authorize to use WellAppoint again.
                        </p>
                      </div>
                    </div>
                  </AdminCard>
