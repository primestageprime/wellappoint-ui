...
export function CreateProviderPage() {
      ...
      if (data.success && data.authUrl) {
        ...
        const checkClosed = setInterval(() => {
          if (popup.closed) {
            ...
            setSuccess(
              "OAuth completed! Please copy the authorization code from the Google page and paste it below, then we can exchange it for a refresh token."
            );
        ...
        data.success &&
        data.error &&
        data.error.includes("Please visit this URL")
      ) {
        ...
        if (urlMatch) {
          ...
          const checkClosed = setInterval(() => {
            if (popup.closed) {
              clearInterval(checkClosed);
              setSuccess(
                "OAuth completed! Please copy the authorization code from the Google page and paste it below."
              );
              setIsOAuthLoading(false);
            }
          }, 1000);
  ...
  const handleProviderSetup = async (e: Event) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccess(
          `Provider ${username()} setup successfully! Redirecting to booking page...`
        );
    ...
    <PageFrame>
      <Content>
        ...
        <div class="text-center mb-8 pt-8">
          <div class="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-amber-100 text-amber-700 mb-3">
            <svg
              class="w-6 h-6"
              fill="none"
              stroke="currentColor"
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg border border-gray-200 shadow-sm mb-6">
          <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">
              Set up a new provider by authenticating with Google and creating
          ...
          <div class="p-6">
            ...
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-600 mb-4">
                First, we need to authenticate with Google to get permission to
                create calendars and sheets.
              </p>
              ...
              <div class="mt-4">
                ...
                <p class="text-xs text-gray-500 mt-2">
                  After completing OAuth, copy the authorization code from the
                  Google page and paste it above.
                </p>
              </div>
              ...
              <form onSubmit={handleProviderSetup} class="space-y-4">
                <div>
                  ...
                  <p class="text-xs text-gray-500 mt-1">
                    URL-safe username for the provider (defaults to emlprime-
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <ul class="text-sm text-gray-600 space-y-1.5">
                  <li>
                    • <span class="font-medium">Step 1:</span> Authenticates
                    with Google to get calendar/sheets permissions
                  </li>
                  <li>
                    • <span class="font-medium">Step 2:</span> Clones the admin
                    sheet template for the provider
                  </li>
                  <li>
                    • <span class="font-medium">Step 2:</span> Creates a
                    WellAppoint calendar in the provider's Google account
                  </li>
                  <li>
                    • <span class="font-medium">Step 2:</span> Adds the provider
                    to the providers spreadsheet
                  </li>
                  <li>
                    • <span class="font-medium">Step 2:</span> Redirects you to
                    the provider's booking page
                  </li>
                </ul>
              </div>
            </div>
