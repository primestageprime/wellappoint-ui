import { Paper, Card, PageFrame, DesignSystemSection } from '../components/visual';
          ...
          <PageFrame>
            <div class="p-6">
              ...
              <p class="text-muted-foreground">
                ...
                and 1rem margin from all edges. It has no internal padding, so content must provide its own padding.
              </p>
            </div>
          </PageFrame>
        </DesignSystemSection>
